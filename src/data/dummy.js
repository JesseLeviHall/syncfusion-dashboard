...
export const EditorData = () => (
  <div>
    <h2> HOW TO ESTABLISH A PAULOWNIA PLANTATION?</h2>
    <h3>
      <p>
        1) SELECT A PLANTATION SITE: The site should contain free draining soil,
        access to full sun and about 1000mm of water per hectare per year
        (unless in a tropical zone with reliable summer rainfalls). The
        protection from severe winds is an advantage. It is important to
        implement soil analyses, so if there is any need of liming to bring the
        pH up to around 6 it can be done prior to cultivation. In Bulgaria, in
        general it is necessary to spread over superphosphate before the time of
        the cultivation.{" "}
      </p>
      <p>
        2) CLEANING OF THE AREA BEFORE THE PLANTATION: All types of wooden
        debris, weeds and others, rake up the pastures and pick up and remove
        all logs, rocks and other debris to allow the construction of proper
        lands.{" "}
      </p>{" "}
      <p>
        3) GROUND WORKS: The plantation construction models are shown below.
        After an assessment of the best model for the specific obstacles and
        planning the best methods the plantation can start. At this stage a
        meeting between all the performers is really appropriate and necessary.
        Discuss what the target is and based on the cultivation and management
        capabilities adapt your plans. You will depend on their experience and
        machinery available and try avoiding any compromise with the needs of
        the Paulownia trees. If this is going to be an irrigated plantation, the
        constructors of the system have to start working on the design in the
        moment when the system can be included at the beginning of the planting.
      </p>
    </h3>
  </div>
);
